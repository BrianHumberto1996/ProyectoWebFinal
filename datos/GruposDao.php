   ...
   /*Metodo que obtiene todos los alumnos de la base de datos, retorna una lista de objetos */
	public function obtenerTodos()
	{
		try
		{
			...
			$sentenciaSQL = $this->conexion->prepare("SELECT clave,tutor,actividad,No_Alumnos FROM vistagrupos;"); /*Se arma la sentencia sql para seleccionar todos los registros de la base de datos*/
			...
			foreach($sentenciaSQL->fetchAll(PDO::FETCH_OBJ) as $fila)
			{
	            ...
	            $obj->No_Alumnos = $fila->No_Alumnos;
